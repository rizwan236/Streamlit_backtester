...
def calculate_trades(df, buy_rsi, buy_cci, sell_rsi, sell_cci):
    ...
    for i in range(1, len(df)):
        ...
        if not in_position and rsi_val > buy_rsi and cci_val > buy_cci and MOMScore > 0.4 and MRP > float(df['MRP'].iloc[i-2] and ST == float(1):
        ...
        elif in_position and rsi_val < sell_rsi and cci_val < sell_cci and ST ==0:
