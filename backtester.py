...
def calculate_trades(df, buy_rsi, buy_cci, sell_rsi, sell_cci):
    ...
    for i in range(30, len(df)):
        ...
        if not in_position and  SMAAD2 * 1.0 < AD and ADX3 < ADX > 25 and PLUS_DI > PLUS_DI3 and (PLUS_DI- MINUS_DI) > 15 and volume_val >= 500 and ( MOMScore > 1.5 or weighted_excessMR > 0.4) and SMAScore24 > -10 and (ST == 1 and EMAMRP24 < MRP and EMAOBV * 1.0 < OBV and close_val > SMAClose10 > SMAClose30 > SMAClose40 and SMAClose40_21 < SMAClose40 > sma_based_sma200 and RSI_e > 50 < RSI_min and RSI_max > 65 and close_val > wkH52 * .75 and close_val > wkL52 * 1.35):    
            ...
            pnl = ((close_val - entry_price) / entry_price * 100) if entry_price !=0 else np.nan
...
if analyze_button:
    try:
        ...
        with st.spinner("Calculating indicators..."):
            ...
            data['EMAOBV']= ta.trend.sma_indicator(OBV, window=32, fillna=False)
